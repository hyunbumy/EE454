...
HD_PWD='/home/hyunbumy/Dropbox/School/Classes/ee454/EE454/project/HW/HW.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hash_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hash_top.tcl
