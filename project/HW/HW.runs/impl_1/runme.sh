...
HD_PWD='/home/hyunbumy/Dropbox/School/Classes/ee454/EE454/project/HW/HW.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hash_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hash_top.tcl -notrace
